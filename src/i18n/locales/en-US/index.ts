...
export const enUS = {
  ...
  quickToolbar: {
    ...
    onlineShort: 'On',
    offlineShort: 'Off',
    goOnline: 'Go online (restore latest published)',
    goOffline: 'Go offline (unload flow from server memory)',
    onlineLocked: 'Flow is locked; cannot toggle online/offline',
    onlineNeedHistory: 'No publish history yet. Publish to live first.',
